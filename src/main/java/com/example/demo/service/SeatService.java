...
import org.springframework.stereotype.Service;import com.example.demo.classes.MySeat;
...
public class SeatService { 
	...
	@Autowired
	SeatRepo seatRepo; public List<MySeat> GetListOfSeats(Integer showid)
	{
